                ...
                <Toast.Header>
                    ...
                    <ButtonGroup vertical className="mr-2">
                        ...
                        <Form.Group className="ml-0 mr-auto" style={{width: "45%"}}>
                            ...
                            <Form.Control isInvalid={props.err["quest"] !== ''} value={props.q.question} onChange={(ev) => { props.editQuestions(props.index, {...props.q, question: ev.target.value});}} ></Form.Control>
                            <Form.Control.Feedback type="invalid">{props.err["quest"]}</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group className="mx-2">
                            <Form.Label>Type</Form.Label>
                            <Form.Control isInvalid={props.err["type"] !== ''} as="select" value={props.q.type} onChange={(ev) => { props.editQuestions(props.index, { ...props.q, type: ev.target.value});}}>
                                <option></option>
